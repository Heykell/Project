...
use Yay_Currency\License\LicenseHandler;
use Yay_Currency\License\License;
...
if ( ! defined( 'YAY_CURRENCY_VERSION' ) ) {
	define( 'YAY_CURRENCY_VERSION', '2.4.2' );
}

if ( ! defined( 'YAY_CURRENCY_PLUGIN_URL' ) ) {
	define( 'YAY_CURRENCY_PLUGIN_URL', plugin_dir_url( YAY_CURRENCY_FILE ) );
}

if ( ! defined( 'YAY_CURRENCY_PLUGIN_DIR' ) ) {
	define( 'YAY_CURRENCY_PLUGIN_DIR', plugin_dir_path( YAY_CURRENCY_FILE ) );
}

if ( ! defined( 'YAY_CURRENCY_BASE_NAME' ) ) {
	define( 'YAY_CURRENCY_BASE_NAME', plugin_basename( YAY_CURRENCY_FILE ) );
}
define( 'YAY_CURRENCY_SELLER_API_URL', 'https://yaycommerce.com/' );
define( 'YAY_CURRENCY_ITEM_ID', 7761 );
...
if ( ! function_exists( 'Yay_Currency\\plugin_init' ) ) {
	function plugin_init() {
		...
		$license = new License( 'yay_currency' );
